...
_SYSTEM = (
    ...
    "'Ha', never use 'bold' or 'bold enough' anywhere, and never use 'my heart races' "
    "or 'heart pounding'.\n"
...
BUTTON_INTENTS = {
    ...
    'new_match': {
        ...
        'prompt': (
            ...
            "singled out, never mass-messaged. Show 'chosen' a DIFFERENT way each time (she made "
            "the first move, he caught her eye, she broke her own rule about messaging first, she "
            "is done waiting around). Do NOT keep saying she swiped past, skipped, or deleted "
            "other matches or guys, and do NOT count app time ('ten minutes in', 'three matches "
            "in') — that comparison is already worn out.\n"
